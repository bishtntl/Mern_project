    ...
    return(
     ...
     <div className="one_container">
        <div className="developement_Top_container">
          <h1 style={{ height: "8vh" }}>Pet Care & Training Courses</h1>
...
"
      ...
      <div className="launguge_dev"> <NavLink to="/life">LifeStyle</NavLink></div>
        <div className="launguge_dev">   <NavLink to="/life/art/craft">Art Crafts</NavLink></div>
        <div className="launguge_dev"> <NavLink to="/life/beauty">Beauty </NavLink></div>
        <div className="launguge_dev">   <NavLink to="/life/pet/craft">Pet Care</NavLink></div>
      </div>
      ...
      <div className="expand_career_dev_column">
        ...
        <div className="flex_container_rating">
          <div className="underflex_column">
            {data
              .filter((item) => item.id >= 241 && item.id <= 243)
              .map((item, index) => {
                return (
                  <>
          ...
          <div className="underflex_column">
            {data
              .filter((item) => item.id >= 243 && item.id <= 246)
              .map((item, index) => {
                return (
                  <>
                    <div key={index} className="underflex_two_rating">
