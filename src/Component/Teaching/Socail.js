    ...
    <>
      ...
      <div className="one_container">
        <div className="developement_Top_container">
          <h1 style={{ height: "8vh" }}>Social Science Courses</h1>
...
"
      ...
      <div className="launguge_dev"><NavLink to="/teaching/Engneering">Engneering</NavLink></div>
        <div className="launguge_dev"> <NavLink to="/teaching/social/science">Socail Science</NavLink></div>
        <div className="launguge_dev"><NavLink to="/teaching/Math">Math</NavLink></div>
        <div className="launguge_dev"><NavLink to="/teaching/Science"> Science</NavLink></div>
      </div>
      ...
      <div className="expand_career_dev_column">
        ...
        <div className="flex_container_rating">
          <div className="underflex_column">
            {data
              .filter((item) => item.id >= 342 && item.id <= 344)
              .map((item, index) => {
                return (
                  <>
          ...
          <div className="underflex_column">
            {data
              .filter((item) => item.id >= 245 && item.id <= 248)
              .map((item, index) => {
                return (
                  <>
                    <div key={index} className="underflex_two_rating">
